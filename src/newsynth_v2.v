...
module sequencer(
    ...
    always @(*) begin
        ...
        // Wacky random dotty sounds:
        n0 = ({1'b0,t[4],t[8],1'b0} + {1'b0,t[6],t[7],1'b0}) ^ t[13:10];
        // n0 = ({1'b0,t[4],t[8],t[9]} + {1'b0,t[6],t[7],t[5]}) ^ t[13:10];
        o0 = 4;

        a0 = t[3:1];

        n1 = ({1'b0,t[6],t[9],1'b0} + {1'b0,t[8],t[7],1'b0}) ^ {t[10],t[12],t[13],t[11]};
        o1 = 3;
